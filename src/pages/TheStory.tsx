    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="gradient-hero pt-28 pb-20 px-4 relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-4xl text-center relative z-10">
          ...
          <p className="text-xl md:text-2xl text-primary-foreground/80 font-medium mb-8">
          ...
          <div className="flex justify-center">
            <a href="#section-0" className="flex items-center gap-1 text-primary-foreground/50 text-sm hover:text-primary-foreground/80 transition-colors">
              Scroll to read <ArrowDown className="w-4 h-4 animate-bounce" />
            </a>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-4 -mt-8 relative z-10">
        <div className="container mx-auto max-w-4xl">
          <div className="bg-card border border-border rounded-2xl p-6 md:p-8 shadow-lg shadow-primary/5">
            <span className="gradient-bg text-primary-foreground px-3 py-1 rounded-md text-xs font-bold uppercase tracking-widest">Summary</span>
            <p className="text-foreground text-lg leading-relaxed font-medium mt-4 mb-3">
      ...
      <section className="py-10 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="grid grid-cols-4 gap-4">
            {[
              { icon: Code2, value: "25k+", label: "Lines of Code" },
              { icon: Database, value: "58", label: "DB Tables" },
        ...
        <div className="container mx-auto max-w-4xl">
          <details className="border border-border rounded-xl overflow-hidden group">
            <summary className="p-5 cursor-pointer flex items-center justify-between hover:bg-muted/50 transition-colors">
              <span className="font-display font-bold text-base flex items-center gap-2">📖 Table of Contents</span>
              <ArrowDown className="w-5 h-5 text-muted-foreground group-open:rotate-180 transition-transform" />
            </summary>
            <div className="px-5 pb-5 grid grid-cols-2 gap-x-6 gap-y-2">
              {[
                ...
                <a key={i} href={`#section-${i}`} className="text-sm text-muted-foreground hover:text-primary transition-colors py-2 flex items-center gap-2">
                  <span className="w-5 h-5 rounded bg-muted text-xs font-bold flex items-center justify-center shrink-0">{i + 1}</span>
                  {s}
                </a>
              ))}
            </div>
      ...
      {/* Section 0: Vision */}
      <section id="section-0" className="py-16 px-4 scroll-mt-20">
        <div className="container mx-auto max-w-4xl">
          ...
          <p className="text-foreground font-display font-bold text-xl mb-5">
          ...
          <div className="grid grid-cols-2 gap-3 mb-6">
            {[
              ...
              <div key={i} className="flex items-center gap-2 py-2.5 px-4 rounded-lg bg-muted/50 text-sm text-muted-foreground">
      ...
      {/* Divider */}
      <div className="container mx-auto max-w-4xl px-4"><div className="border-t border-border" /></div>

      {/* Section 1: Skills */}
      <section id="section-1" className="py-16 px-4 scroll-mt-20">
        <div className="container mx-auto max-w-5xl">
              ...
              <div key={i} className="bg-card border border-border rounded-xl p-6 hover:shadow-md hover:border-primary/20 transition-all">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="font-display font-bold text-base">{skill.title}</h3>
                  </div>
                  <span className="text-xs font-bold px-3 py-1 rounded gradient-bg text-primary-foreground">⚡ {skill.time}</span>
                </div>
                <div className="grid grid-cols-2 gap-2 mb-4">
                  {skill.features.map((f, j) => (
                    <span key={j} className="text-sm text-muted-foreground flex items-center gap-2">
                      <span className="w-1.5 h-1.5 rounded-full gradient-bg shrink-0" /> {f}
                    </span>
                  ))}
                </div>
                <div className="flex items-center justify-between pt-4 border-t border-border">
                  <span className="text-xs text-muted-foreground">Was: <strong className="text-foreground">{skill.cost}</strong></span>
                  <span className="text-sm font-semibold gradient-text">{skill.impact}</span>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="mt-5 grid grid-cols-3 gap-4">
            {[
              ...
              <div key={i} className="border border-border rounded-lg p-4 text-center bg-card">
                <span className="text-2xl">{item.emoji}</span>
                <h4 className="font-display font-bold text-sm mt-2">{item.title}</h4>
      ...
      {/* Section 2: Numbers */}
      <section id="section-2" className="py-16 px-4 gradient-subtle-bg scroll-mt-20">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-10">
          ...
          <div className="grid grid-cols-2 gap-5 mb-6">
            <div className="border-2 border-border rounded-2xl p-7 bg-card relative">
              <span className="absolute -top-3 left-4 px-3 py-0.5 bg-card border border-border rounded text-xs font-bold text-muted-foreground">TRADITIONAL</span>
              <div className="font-display text-4xl md:text-5xl font-bold text-foreground mt-2">$500k<span className="text-xl">+</span></div>
              <p className="text-sm text-muted-foreground mt-2">12+ months • 10+ devs</p>
            </div>
            <div className="gradient-bg rounded-2xl p-7 relative">
              <span className="absolute -top-3 left-4 px-3 py-0.5 bg-card rounded text-xs font-bold text-foreground">WITH AI</span>
              <div className="font-display text-4xl md:text-5xl font-bold text-primary-foreground mt-2">$190</div>
              <p className="text-sm text-primary-foreground/70 mt-2">2 weeks • 1 person</p>
            </div>
          </div>

          <div className="grid grid-cols-2 gap-5">
            <div className="text-center py-7 rounded-xl bg-card border border-border">
              <div className="font-display text-4xl font-bold gradient-text">25x</div>
              <p className="text-sm text-muted-foreground mt-2">Cost Reduction</p>
            </div>
            <div className="text-center py-7 rounded-xl bg-card border border-border">
              <div className="font-display text-4xl font-bold gradient-text">26x</div>
      ...
      <section id="section-3" className="py-16 px-4 scroll-mt-20">
        <div className="container mx-auto max-w-4xl">
          ...
          <blockquote className="gradient-bg rounded-xl p-7 mb-8 text-primary-foreground">
            <p className="font-display text-lg md:text-xl font-bold leading-relaxed">
          ...
          <div className="space-y-3 mb-8">
            {[
              ...
              <div key={item.n} className="flex gap-4 items-start border border-border rounded-lg p-5 bg-card hover:border-primary/20 transition-colors">
                <span className="font-display text-xl font-bold gradient-text shrink-0 w-8">{item.n}</span>
                <div>
                  <p className="font-display font-bold text-base">{item.title}</p>
      ...
      <section id="section-4" className="py-16 px-4 gradient-subtle-bg scroll-mt-20">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-10">
          ...
          <div className="grid sm:grid-cols-2 gap-5">
            {[
              ...
              <div key={i} className="bg-card border border-border rounded-xl p-6 flex gap-4 items-start hover:shadow-md hover:border-primary/20 transition-all">
      ...
      <section id="section-5" className="py-16 px-4 scroll-mt-20">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            {[
              ...
              <div key={i} className="border border-border rounded-xl p-5 bg-card">
                <h4 className="font-display font-bold text-xs mb-3 gradient-text uppercase tracking-wider">{g.cat}</h4>
          ...
          <div className="gradient-bg rounded-xl p-7 text-center text-primary-foreground">
            <p className="font-display text-3xl md:text-4xl font-bold">$5k–$15k<span className="text-lg font-normal opacity-70">/month saved</span></p>
            <p className="text-sm opacity-70 mt-2">Plus increased revenue, retention & unlimited automation</p>
          </div>
        </div>
      </section>

      {/* Section 6: Dark Truth */}
      <section id="section-6" className="py-16 px-4 gradient-subtle-bg scroll-mt-20">
        <div className="container mx-auto max-w-4xl">
          ...
          <blockquote className="gradient-bg rounded-xl p-7 text-primary-foreground text-center">
      ...
      {/* Section 7: Agencies */}
      <section id="section-7" className="py-16 px-4 scroll-mt-20">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="grid grid-cols-3 gap-4 mb-6">
            {[
              ...
              <div key={i} className="border border-border rounded-xl p-5 text-center bg-card hover:border-primary/20 transition-colors">
      ...
      {/* Section 8: Future */}
      <section id="section-8" className="py-16 px-4 gradient-subtle-bg scroll-mt-20">
        <div className="container mx-auto max-w-4xl text-center">
          <SectionLabel>Paradigm Shift</SectionLabel>
          <h2 className="font-display text-3xl md:text-4xl font-bold mb-6">
            The Future Is <span className="gradient-text">Already Here</span>
          </h2>
          <blockquote className="gradient-bg rounded-xl p-7 text-primary-foreground mb-8">
            <p className="font-display text-lg md:text-xl font-bold">
          ...
          <div className="grid grid-cols-2 gap-5">
            <div className="border-2 border-border rounded-xl p-6 bg-card">
              <p className="text-xs text-muted-foreground uppercase tracking-wider font-bold mb-3">Old Way</p>
              <p className="font-display font-bold text-base">Money → Talent → Speed</p>
            </div>
            <div className="gradient-bg rounded-xl p-6">
              <p className="text-xs text-primary-foreground/60 uppercase tracking-wider font-bold mb-3">New Way</p>
              <p className="font-display font-bold text-base text-primary-foreground">Knowledge → Prompts → Speed</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Section 9: Roadmap */}
      <section id="section-9" className="py-16 px-4 scroll-mt-20">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={i} className="flex items-center gap-4 border border-border rounded-lg p-4 bg-card hover:border-primary/20 transition-colors">
                <span className="w-7 h-7 rounded gradient-bg text-primary-foreground flex items-center justify-center text-xs font-bold shrink-0">{i + 1}</span>
                <div className="flex items-center justify-between flex-1 gap-3">
                  <p className="font-display font-bold text-sm">{item.title}</p>
                  <p className="text-sm text-muted-foreground hidden sm:block">{item.desc}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      {/* Section 10: Message */}
      <section id="section-10" className="py-16 px-4 gradient-subtle-bg scroll-mt-20">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <div className="bg-card border border-border rounded-2xl p-8 md:p-10 shadow-sm">
            <p className="font-display text-2xl font-bold text-foreground mb-3">One AI partner. Relentless execution.</p>
            <p className="text-base text-muted-foreground mb-6">That's all it takes now.</p>
      ...
      <section id="section-11" className="py-20 px-4 scroll-mt-20">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-10">
            <p className="text-muted-foreground text-base leading-relaxed mb-3">
              A solo founder can outpace entire teams. A bootstrapper can out-innovate VC-backed companies.
            </p>
            <p className="font-display text-3xl font-bold text-foreground">Aiva is proof.</p>
          </div>

          <div className="gradient-bg rounded-2xl p-10 md:p-12 text-center text-primary-foreground">
            ...
            <p className="text-sm opacity-70 max-w-md mx-auto mb-1">
              Her conception story. Born in 2 weeks. Ready to master every skill. Her growth will be rapid. 💥
            </p>
            <a href="#" className="inline-flex items-center gap-2 bg-background text-foreground px-7 py-3 rounded-full font-semibold mt-6 hover:bg-background/90 transition-colors text-base">
